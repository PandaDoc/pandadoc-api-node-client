...
export class DocumentsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async documentCreate(documentCreateRequest: DocumentCreateRequest, editorVer?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (documentCreateRequest === null || documentCreateRequest === undefined) {
            throw new RequiredError("DocumentsApi", "documentCreate", "documentCreateRequest");
        }
     ...
     */
    public async documentStatusChange(id: string, documentStatusChangeRequest: DocumentStatusChangeRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("DocumentsApi", "documentStatusChange", "id");
        }
        ...
        if (documentStatusChangeRequest === null || documentStatusChangeRequest === undefined) {
            throw new RequiredError("DocumentsApi", "documentStatusChange", "documentStatusChangeRequest");
        }
...
export class DocumentsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to documentStatusChange
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async documentStatusChange(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return;
        }
