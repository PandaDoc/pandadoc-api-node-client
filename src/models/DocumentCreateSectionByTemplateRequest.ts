...
export class DocumentCreateSectionByTemplateRequest {
    /**
    * The ID of a document you want to assign the new section to.
    */
    'documentUuid': string;
    /**
    * The ID of a template you want to create a section with. You can copy it from an in app template url such as `https://app.pandadoc.com/a/#/templates/{ID}/content`. A template ID is also obtained by listing templates.
    */
    'templateUuid': string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return DocumentCreateSectionByTemplateRequest.attributeTypeMap;
    }
