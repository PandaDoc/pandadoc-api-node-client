...
*/
export class UpdateIntegrationQuoteSectionItemPriceSettings {
    /**
    ...
    */
    ...
    'tiers': Array<UpdateIntegrationQuoteSectionItemPriceSettingsTiersInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "tiers",
            "baseName": "tiers",
            "type": "Array<UpdateIntegrationQuoteSectionItemPriceSettingsTiersInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return UpdateIntegrationQuoteSectionItemPriceSettings.attributeTypeMap;
    }
